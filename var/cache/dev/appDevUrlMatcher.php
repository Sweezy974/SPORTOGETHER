    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/new/RencontrePublic') {
            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                ...
                goto not_RencontrePublic_new;
            }

            return array (  '_controller' => 'sportogether\\Bundle\\Controller\\RencontrePublicController::newAction',  '_route' => 'RencontrePublic_new',);
        }
        not_RencontrePublic_new:

        // RencontrePublic_show
        if ($pathinfo === '/show/RencontrePublic') {
            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'HEAD'));
                goto not_RencontrePublic_show;
            }

            return array (  '_controller' => 'sportogether\\Bundle\\Controller\\RencontrePublicController::indexAction',  '_route' => 'RencontrePublic_show',);
        }
